...
//    private VisionImageProcessor imageProcessor;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN || keyCode == KeyEvent.KEYCODE_VOLUME_UP) {
            ...
            Toast.makeText(SecondActivity.this, "Captured.", Toast.LENGTH_SHORT).show();
...
//                        .format(System.currentTimeMillis()) + ".jpg");
            ...
            File photoFile = new File(storageDir, subject+"_P2_" +session+"_"+subjCount+ ".jpg");
            ...
            captureUseCase.takePicture(outputFileOptions, mImageCaptureExecutorService, new ImageCapture.OnImageSavedCallback() {
                ...
                public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                    ...
                    Intent intent = new Intent(SecondActivity.this, AfterCaptureActivity2.class);
                    SharedPreferences mPrefs = getSharedPreferences(SHARED_PREF, MODE_PRIVATE);
                    SharedPreferences.Editor prefsEditor = mPrefs.edit();
                    prefsEditor.putBoolean("pose_two", true).apply();
...
//        }
        ...
        graphicOverlay.add(new CameraImageGraphic2(graphicOverlay));
...
//                    imageProcessor = new FaceDetectorProcessor2(this, faceDetectorOptions);
//                    break;
//                default:
