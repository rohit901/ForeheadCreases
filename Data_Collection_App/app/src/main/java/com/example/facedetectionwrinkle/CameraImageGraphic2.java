 ...
 */
public class CameraImageGraphic2 extends GraphicOverlay.Graphic {
    ...
    public CameraImageGraphic2(GraphicOverlay overlay) {
        super(overlay);
    ...
    public void draw(Canvas canvas) {
        ...
        float left = 0.070f;
        RectF oval = new RectF(left*width,0.0225f*height, (1-left)*width,0.7925f*height);


        RectF foreHead = new RectF(0.03f*width, 0.14f*height, 0.97f*width,0.36f*height);
